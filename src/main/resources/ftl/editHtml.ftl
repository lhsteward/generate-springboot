...
<body  th:attr="data-id=${r"${"} teacher_id ${r"}"}">
<div style="padding:10px;">
	<span class="layui-breadcrumb" lay-separator=">>" style="padding-left: 20px;padding-top: 20px;">
        ...
        <a style="font-size: 14px;"><cite>修改课程</cite></a>
    </span>
    <hr/>
...
<script type="text/javascript" src="../../static/teacher/edit.js" th:src="@{~/static/teacher/edit.js}"></script>
</html>